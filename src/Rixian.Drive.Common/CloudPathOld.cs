...
//    /// </summary>
//    public sealed class CloudPathOld : IEquatable<CloudPathOld>, IEquatable<string>
//    {
//        /// <summary>
...
//        private static readonly string CloudPathOldRegexString = $@"(?:^(?:{RegexDirectorySeparator}{RegexDirectorySeparator}(?<{ShareLabelName}>[^{RegexDirectorySeparator}{InvalidRegexCharacters}]+))|^(?:(?<{PartitionLabelName}>[^{RegexDirectorySeparator}{InvalidRegexCharacters}]+){RegexPartitionSeparator}))?(?<{PathName}>[^{InvalidRegexCharacters}]*)(?:\:(?<{StreamName}>[^{InvalidRegexCharacters}]+))?$";

//        /// <summary>
//        /// Initializes a new instance of the <see cref="CloudPathOld"/> class.
//        /// </summary>
//        /// <param name="path">The full or ralative path.</param>
//        public CloudPathOld(string path)
//        {
//            (CloudPathOldType type, string label, string path, string stream) result = ParseInternal(path);

//            if (string.IsNullOrWhiteSpace(result.label))
//            {
//                result.type = CloudPathOldType.None;
//            }
...
//        public CloudPathOld(CloudPathOldType type, string label, string path, string stream)
//        {
//            if (string.IsNullOrWhiteSpace(label))
//            {
//                type = CloudPathOldType.None;
//            }
...
//        /// </summary>
//        public static string CloudPathOldRegex
//        {
//            get
//            {
//                return CloudPathOldRegexString;
//            }
//        }
...
//        /// </summary>
//        public static CloudPathOld Root
//        {
//            get
//            {
//                return new CloudPathOld("/");
//            }
//        }
...
//        /// Gets the path type.
//        /// </summary>
//        public CloudPathOldType Type { get; }
...
//        /// <summary>
//        /// Converts a <see cref="CloudPathOld"/> to a string.
//        /// </summary>
//        /// <param name="input">The input string.</param>
//        public static implicit operator CloudPathOld(string input)
//        {
//            if (input == null)
//            {
//                return null;
...
//            return new CloudPathOld(input);
//        }

//        /// <summary>
//        /// Converts a <see cref="CloudPathOld"/> to a string.
//        /// </summary>
//        /// <param name="input">The input <see cref="CloudPathOld"/>.</param>
//        public static implicit operator string(CloudPathOld input)
//        {
...
//        /// </summary>
//        /// <param name="input">The input string.</param>
//        /// <returns>The <see cref="CloudPathOld"/> or null.</returns>
//        public static CloudPathOld FromString(string input)
//        {
//            if (input == null)
//            {
//                return null;
...
//        /// <summary>
//        /// Parses the provided path as an instance of a <see cref="CloudPathOld"/>.
//        /// </summary>
//        /// <param name="path">The path to parse.</param>
//        /// <returns>The parsed <see cref="CloudPathOld"/>.</returns>
//        public static CloudPathOld Parse(string path)
//        {
//            path = path?.Trim()?.Replace('\\', '/');

//            Match match = Regex.Match(path, CloudPathOldRegex);
...
//                return new CloudPathOld(CloudPathOldType.Share, matchedLabel, matchedPath, matchedStream);
//            }
//            else
//            {
//                return new CloudPathOld(CloudPathOldType.Partition, matchedLabel, matchedPath, matchedStream);
//            }
//        }
...
//        {
//            (CloudPathOldType type, string label, string path, string stream) parsed = ParseInternal(path);

//            var normalizedPath = NormalizePathInternal(parsed.path);

//            return new CloudPathOld(parsed.type, parsed.label, normalizedPath, parsed.stream).ToString();
//        }
...
//            return new CloudPathOld(path).Stream;
//        }
...
//            switch (this.Type)
//            {
//                case CloudPathOldType.Share:
//                    return $"{SharePrefix}{this.Label}{this.Path}{stream}";
//                case CloudPathOldType.Partition:
...
//        /// <summary>
//        /// Returns a new <see cref="CloudPathOld"/> formatted as a directory.
//        /// </summary>
//        /// <returns>A <see cref="CloudPathOld"/> formatted as a directory.</returns>
//        public CloudPathOld FormatAsDirectory()
//        {
...
//            else
//            {
//                return new CloudPathOld(this.Type, this.Label, this.Path + DirectorySeparator, this.Stream);
//            }
//        }
...
//        /// </summary>
//        /// <returns>A <see cref="CloudPathOld"/> formatted as a directory.</returns>
//        public CloudPathOld FormatAsFile()
//        {
//            if (!this.IsDirectoryPath)
//            {
//                return this;
...
//            else
//            {
//                return new CloudPathOld(this.Type, this.Label, this.Path.TrimEnd(DirectorySeparator), this.Stream);
//            }
//        }

//        /// <summary>
//        /// Creates a new instance of a CloudPathOld that contains a stream name.
//        /// </summary>
//        /// <param name="stream">The stream name.</param>
//        /// <returns>The existing cloud path with the stream name.</returns>
//        public CloudPathOld WithStream(string stream)
//        {
...
//            return new CloudPathOld(this.Type, this.Label, this.Path, stream);
//        }

//        /// <inheritdoc/>
//        public bool Equals(CloudPathOld other)
//        {
//            if (other == null)
//            {
//                return false;
...
//            return this.Equals((CloudPathOld)other);
//        }
...
//            return this.Equals(obj as CloudPathOld);
//        }
...
//        private static (CloudPathOldType type, string label, string path, string stream) ParseInternal(string path)
//        {
//            path = path?.Trim()?.Replace('\\', '/');
...
//                if (string.IsNullOrWhiteSpace(matchedLabel))
//                {
//                    return (CloudPathOldType.None, null, matchedPath, matchedStream);
//                }

//                return (CloudPathOldType.Share, matchedLabel, matchedPath, matchedStream);
//            }
//            else
//            {
//                return (CloudPathOldType.Partition, matchedLabel, matchedPath, matchedStream);
//            }
//        }
